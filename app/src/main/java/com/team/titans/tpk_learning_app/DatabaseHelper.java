...
public class DatabaseHelper extends SQLiteOpenHelper{
	...
	// Words table name
	public static final String tWords = "words";

	// Words Table Column names
	public static final String kID = "id";
	public static final String kEnglish = "english";
	public static final String kTamil = "tamil";
	...
	public void addWord(Word word) {
		...
		//values.put(kID, id); // get Default Translation
	...
	public ArrayList<Word> getWords(String category){
		...
		Cursor cursor = db.query(tWords, columns," category = ?", new String[] { String.valueOf(category) },null,null,"id",null);
